  ...
  return (
    <div className="w-full h-screen">
      ...
      <div className="absolute top-0 w-full h-full flex flex-col justify-center text-white">
        ...
        {/* left-[10%] will only work if it is absolute */}
        <div className="md:left-[10%] max-w-[1100px] m-auto absolute p-4">
            <p>All Inclusive</p>
            <h1 className="font-bold text-5xl md:text-7xl drop-shadow-2xl">Private Beaches & Gateways</h1>
            <p className="max-w-[600px] drop-shadow-2xl py-2 text-xl">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero ratione dolore necessitatibus error! Aut nisi laboriosam minima unde consequatur dolores?
            </p>
