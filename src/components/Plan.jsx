  ...
  return (
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="text-2xl py-6 ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, obcaecati.</p>
        <p className="pb-6">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Perferendis inventore sunt, explicabo cum consectetur voluptate repellendus fuga quam, labore pariatur vitae officiis, aliquid esse quibusdam commodi laborum ad animi molestias!</p>
        <div>
